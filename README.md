...
```bash
$ cd wordpress-folder/wp-content/themes/catalog
$ npm install
```

### 2. While you're working on the project, run:
...
* [Ole Fredrik's FoundationPress](https://github.com/olefredrik/FoundationPress)
